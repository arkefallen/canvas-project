...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mColorBg = ResourcesCompat.getColor(getResources(), R.color.colorBG, null);
        mColorRect = ResourcesCompat.getColor(getResources(), R.color.colorRect, null);
            ...
            public void onClick(View view) {
                ...
                if (mOffset==OFFSET) {
                    ...
                    if (mOffset < halfWidth && mOffset < halfHeight) {
                        ...
                        int mColorAccent = ResourcesCompat.getColor(getResources(), R.color.white, null);
